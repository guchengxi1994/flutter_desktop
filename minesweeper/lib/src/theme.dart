...
CustomThemeData customThemeData = CustomThemeData(
  ...
  windowTitleColor: const Color(0xFF010183),
  fillColor: const Color(0xFFc4c4c4),
  fillColorDark: const Color(0xff979797),
  cardText: const TextStyle(
    fontSize: 18,
  ),
  cardTextHighlighted: const TextStyle(
    fontSize: 18,
    color: primaryColor,
    fontWeight: FontWeight.bold,
  ),
  homePageMainStatText: const TextStyle(
    fontSize: 40,
    fontWeight: FontWeight.bold,
    color: Colors.white,
  ),
  homePageStatText: const TextStyle(
    fontSize: 20,
    fontWeight: FontWeight.bold,
    color: Colors.white,
  ),
  cardTitleText: const TextStyle(
    fontSize: 20,
    fontWeight: FontWeight.bold,
    color: Colors.white,
  ),
